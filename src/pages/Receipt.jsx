    ...
    <section className="receipt" >
      ...
      {orders.map((order) => (
        <section className="receiptCard" key={order.name}>
          ...
          <h1 className="orderTitle" id="dottedLine">{order.name}</h1>
      ...
      <section className="barcodeContainer">
        <section className="totalPrice">Receipt - {from.totalPrice} SEK</section>
        <img className="barcode" src="https://svgsilh.com/svg/306926.svg" alt="barcode" />
